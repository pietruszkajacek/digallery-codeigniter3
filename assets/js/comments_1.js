...
function add_gallery_comment(event)
{
...
function add_profile_comment(event)
{
	if ($('#send-comment-textarea').val() != '')
	{
		$.ajax({
...
function add_image_comment(event)
{
	if ($('#send-comment-textarea').val() != '')
	{
		$.ajax({
...
function open_signin_dropdown(event) 
{
...
function comments_init(commenting_function_name)
{
