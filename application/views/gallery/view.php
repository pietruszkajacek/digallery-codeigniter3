		...
		<div class="span11">
			...
			<ul class="pager">
				<?php if (isset($previous_image_index)) : ?>
					<li class="previous">
						<?php echo anchor("gallery/view/$gallery->id/$previous_image_index" . '/' . url_slug($gallery->name, array('transliterate' => TRUE)), '&larr; poprzednia', array());
						?>
					</li>				
				<?php else : ?>
				...
				<?php if (isset($next_image_index)) : ?>
					<li class="next">
						<?php echo anchor("gallery/view/$gallery->id/$next_image_index" . '/' . url_slug($gallery->name, array('transliterate' => TRUE)), 'następna &rarr;', array());
						?>
					</li>				
				<?php else : ?>
